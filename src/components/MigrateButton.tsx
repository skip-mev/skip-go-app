...
const MigrateButton = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-4 right-4 z-10 flex cursor-pointer items-center gap-3 rounded-2xl border-2 border-solid border-red-400 bg-black px-4 py-3 font-diatype text-white sm:[@media(min-width:787px)]:hidden">
        <img
          src={NOBLE_USDC_IMG}
          alt="Noble USDC"
          width={36}
        ...
        <span className="flex-1">
          <span className="block whitespace-nowrap text-[15px] font-semibold">
            Noble USDC.n is being <span className="text-red-500">deprecated</span>
          </span>
      ...
      <div className="fixed bottom-20 right-8 z-10 hidden w-[20%] min-w-[300px] flex-col overflow-hidden rounded-3xl border-2 border-solid border-red-400 bg-black font-diatype text-white sm:[@media(min-width:787px)]:flex">
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <button
            ...
            className="mt-0 flex flex-shrink-0 cursor-pointer items-center justify-center rounded-full border-none bg-black text-white/70 transition-colors hover:text-white"
          >
            <span className="text-[32px] font-light leading-none">×</span>
          </button>
        </div>

        <div className="flex flex-col px-5 pb-6 pt-0">
          ...
          <div className="my-4 h-px bg-red-500/40" />
