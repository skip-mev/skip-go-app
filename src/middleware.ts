...
const corsOptions = {
  ...
  "Access-Control-Allow-Headers":
    "Content-Type, Authorization, solana-client, sentry-trace, baggage, x-client-url, x-client-version, x-client-name, x-client-sample-rate, x-client-library, x-grpc-web",
};
